...
// Define dispatch to props mapping
const mapDispatchToProps = {
  palletsMasterDataAction,
  barcodeScanApi: getITODescriptionAction,
  getPoid: getPODescriptionAction,
    ...
    <>
      ...
      {alertMessage.show && (
        <AppAlert
          ...
          headerText={alertMessage.headerText}
          btnCancelText={alertMessage.btnCancelText}
          btnOkText={alertMessage.btnOkText}
          handleClose={() => setAlertMessage({ ...alertMessage, show: false })}
        />
      )}
    </>
  );
