...
// Define the type for PalletData
...
// Function to print the pallet label
export const printLabel = (palletData: PalletData): void => {
  const content = `
    <br/><br/>
    <div>${getPalletLabel(palletData)}<div><br/><br/><br/><br/></div>${getPalletLabel(palletData)}</div>
  `;
...
// Helper function to convert text to a base64 barcode image
...
// Function to generate the pallet label HTML
      ...
      <table style="border: 1px solid black; width: 100%; height: 40%; border-collapse: collapse;">
        ...
        <tr>
          ...
          <td style="border: 1px solid black; vertical-align: top; text-align: center;">
            <table style="height: 0px;">
              <tr>
                <td><label>DATE WRAPPED</label></td>
              </tr>
            </table>
            <br />
